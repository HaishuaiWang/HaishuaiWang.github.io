...
His research focuses on time series/graph data mining, medical artificial intelligence, multimodal biomedical large models, and deep learning. His research has been published more than 100 papers in top conference and journals, including Nature series, Cell series, NeurIPS, KDD, AAAI, ICCV, and TKDE. He serves as Program Committee (e.g., IJCAI, KDD, AAAI, WWW), Workshop Organizer ()
